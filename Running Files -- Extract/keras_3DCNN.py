...
model.add(Conv3D(64, kernel_size=(5, 5, 5), border_mode='same', strides=(1,1,1)))
model.add(Activation('relu'))
model.add(MaxPooling3D(pool_size=(3, 3, 3), border_mode='same', strides=(1,1,1)))
model.add(Dropout(0.5))
...
#x = keras.layers.concatenate([last, auxiliary_input])
